(function () {
  ...
  const pastaTemplates = [
    ...
    {
      name: 'のボロネーゼ風',
      base: ['スパゲッティ', '合い挽き肉', '玉ねぎ', 'トマト缶', 'にんにく', 'ケチャップ', 'コンソメ'],
      note: 'ミートソース / ガッツリ / お子様にも人気'
    },
    {
      name: 'のアラビアータ',
      base: ['スパゲッティ', 'トマト缶', 'にんにく', '唐辛子', 'オリーブオイル', '塩', 'こしょう'],
      note: 'ピリ辛トマトソース / 刺激的 / お酒に合う'
    },
    {
      name: 'のトマトクリームパスタ',
      base: ['スパゲッティ', 'トマト', '生クリーム', 'にんにく', 'コンソメ', '塩', 'こしょう'],
      note: 'まろやかトマト / 女性に人気 / 濃厚'
    },
    {
      name: 'の梅しそ和風パスタ',
      base: ['スパゲッティ', '梅干し', '大葉', 'めんつゆ', 'ごま油', '白ごま'],
      note: '梅しそ風味 / さっぱり / 夏バテ気味の時に'
    },
    {
      name: 'の柚子胡椒パスタ',
      base: ['スパゲッティ', '柚子胡椒', 'オリーブオイル', 'だし', '醤油', 'ねぎ'],
      note: 'ピリ辛和風 / 柚子の香り / 大人向け'
    },
    {
      name: 'のカレー風味パスタ',
      base: ['スパゲッティ', 'カレー粉', '玉ねぎ', 'ケチャップ', 'コンソメ', 'オリーブオイル'],
      note: 'スパイシーカレー味 / 食欲そそる / アレンジ自在'
    },
    {
      name: 'のごま豆乳スープパスタ',
      base: ['スパゲッティ', '無調整豆乳', 'すりごま', '鶏ガラスープの素', '醤油', 'ラー油'],
      note: 'まろやか豆乳スープ / 担々麺風 / ぽかぽか温まる'
    },
    {
      name: 'のツナマヨぽん酢パスタ',
      base: ['スパゲッティ', 'ツナ缶', 'マヨネーズ', 'ぽん酢', 'ねぎ', 'のり'],
      note: 'ツナマヨ味 / 子供も大好き / 超簡単'
    },
    {
      name: 'の焦がしにんにく醤油パスタ',
      base: ['スパゲッティ', 'にんにく', '醤油', 'バター', '黒こしょう', 'ねぎ'],
      note: 'ガツンとニンニク / 香ばしい / 男飯'
    },
    {
      name: 'の塩昆布バターパスタ',
      base: ['スパゲッティ', '塩昆布', 'バター', 'オリーブオイル', 'ねぎ', '白ごま'],
      note: '旨みたっぷり / 調味料不要 / 和風'
    }
  ];
